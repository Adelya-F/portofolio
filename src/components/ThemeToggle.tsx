...
// Avoids a hydration mismatch: the server doesn't know the persisted theme,
// so the toggle renders a placeholder until the client has mounted.
function useMounted() {
...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-9 w-9 items-center justify-center rounded-lg border border-border text-muted transition-colors hover:bg-surface-hover hover:text-foreground"
    >
      {isDark ? (
        <svg
